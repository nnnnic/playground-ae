...
$( 'document' ).ready(function() {
  keyBoxPos = $(".timeline-animation").position();
  keyBoxDim = $(".timeline-animation").width();
  timeBarKeyframe; // for use gathering timeline position offsets when dragging selected bar
